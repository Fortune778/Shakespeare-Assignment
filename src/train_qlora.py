...
data_files = [
    os.path.join(PROJECT_ROOT, "data", "raw", "hamlet_utterances.jsonl"), 
    os.path.join(PROJECT_ROOT, "data", "raw", "macbeth_utterances.jsonl"), 
    os.path.join(PROJECT_ROOT, "data", "raw", "romeo_and_juliet_utterances.jsonl")
]
...
training_args = SFTConfig(
    output_dir="./models/shakespeare_lora_checkpoints",
...
trainer.model.save_pretrained("models/shakespeare_lora_final")
tokenizer.save_pretrained("models/shakespeare_lora_final")
print("All done. The 'models/shakespeare_lora_final' folder is ready for your Chatbot.")
