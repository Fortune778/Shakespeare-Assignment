...
faiss.write_index(index, os.path.join(PROJECT_ROOT, "data", "preprocessed", "beam_shakespeare_master.index"))
with open(os.path.join(PROJECT_ROOT, "data", "preprocessed", "beam_master_metadata.json"), "w", encoding='utf-8') as f:
